...
echo "  qm create ${TEMPLATE_ID} --name talos-nocloud-template --memory 4096 --cores 2 --net0 virtio,bridge=vmbr0 --machine q35 --bios ovmf"
echo "  qm set ${TEMPLATE_ID} --efidisk0 local-lvm:4M"
...
echo "  qm set ${TEMPLATE_ID} --cpu host --ostype l26"
echo "  qm set ${TEMPLATE_ID} --balloon 0"
